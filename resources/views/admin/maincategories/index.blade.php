    ...
    <div class="card card-cascade narrower">
      ...
      <div class="px-4">
        ...
        <div class="table-wrapper">
            <a href="{{route('admin.maincategories.create')}}" class="float-right btn bg-green text-bold mt-3" style="font-size: 18px;">+ Add New Category</a>
          <!--Table-->
          <table id="dtBasicExample" class="table table-hover mb-0">
            ...
            <tr deletedid="{{$mainCategory->id}}">
              <td>{{$mainCategory->name}}</td>
                ...
                <td statusactive="{{$mainCategory->id}}"><p style="color: @if($mainCategory->active=='0') red @else green @endif">@if($mainCategory->active=='0')Not Active @else Active @endif</p></td>
              ...
              <td> <div>
                  ...
                  <a href="{{route('admin.maincategories.delete')}}" deleteid="{{$mainCategory->id}}" class="catdelete"  style="color:red;">
