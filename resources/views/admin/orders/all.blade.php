...
@section('content')
  ...
  <div class="content-wrapper bg-white pt-1" style="min-height: 1416.81px;">
    ...
    <div class="card card-cascade narrower">
      ...
      <!--Card image-->
        <h2 class=" card card-header white-text text-center mx-3 bg-success">Orders</h2>
        ...
        <div class="table-wrapper">
          ...
          <table id="dtBasicExample" class="table table-hover mb-0">
            ...
            <tr>
              ...
              <th class="th-lg">rest name<i class="fas fa-sort ml-1"></i></th>
            ...
            <tr deletedid="{{$invoice->id}}">
              ...
              <td style="color: @if($invoice->status==0) red @elseif($invoice->status==1) gold @elseif($invoice->status==2) cyan @elseif($invoice->status==3) blue @elseif($invoice->status==4) green @endif;">
                  @if($invoice->status==0) Cancelled @elseif($invoice->status==1) Pending @elseif($invoice->status==2) Prepared @elseif($invoice->status==3) On The Way @elseif($invoice->status==4) Completed @endif
              </td>
              <td> <div>
