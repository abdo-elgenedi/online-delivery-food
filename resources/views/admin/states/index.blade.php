...
@section('content')
  ...
  <div class="content-wrapper bg-white pt-1" style="min-height: 1416.81px;">
    ...
    <div class="card card-cascade narrower">
      ...
      <!--Card image-->
        <h2 class=" card card-header white-text text-center mx-3 bg-blue">States</h2>
      ...
      <div class="px-4">
        ...
        <div class="table-wrapper">
            <a href="{{route('admin.states.create')}}" class="float-right btn bg-green text-bold mt-3" style="font-size: 18px;">+ Add New State</a>
          <!--Table-->
          <table id="dtBasicExample" class="table table-hover mb-0">
            ...
            <tr>
              ...
              <th class="th-lg">Name<i class="fas fa-sort ml-1"></i></th>
                <th class="th-lg">City<i class="fas fa-sort ml-1"></i></th>
            ...
            <tr deletedid="{{$state->id}}">
              <td>{{$state->name}}</td>
                <td>{{(\App\Models\City::where('id',$state->city_id)->select('name')->first())->name}}</td>
              <td>
                  <div>
                  <a href="{{route('admin.states.edit',$state->id)}}" class="btn btn-outline-white btn-rounded btn-sm px-2" style="color:#007bff;">
                    <i class="fas fa-pencil-alt mt-0"></i>
                  </a>
                  <a href="{{route('admin.states.delete')}}" deleteid="{{$state->id}}" class="statedelete"  style="color:red;">
  ...
  <script>
    ...
    <script>
        ...
        $(document).on('click','.statedelete',function (e) {
            e.preventDefault();
