                    ...
                    <div class="modal-body">
                        <div class="row m-1">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>{{$invoice->address}}</p>
                                <p>Mobile: <span>{{$invoice->vendor->mobile}}</span></p>
                            </div>
                        </div>
                            ...
                            <table class="col-md-12 table table-striped">
                                ...
                                @foreach($invoice->orders as $order)
                                    <tr class="p-1">
                                        ...
                                        <td class="text-right">{{\App\Models\Product::find($order->product_id)->price}} EGP</td>
                                        <td class="text-right">{{(\App\Models\Product::find($order->product_id)->price)*($order->quantity)}} EGP</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
