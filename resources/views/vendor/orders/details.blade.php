                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row m-1">
                            ...
                            <div class="col-md-6">
                                <p>Address: <span>{{\App\Models\City::find(Auth::user()->city_id)->name}} ــ {{\App\Models\State::find(Auth::user()->state_id)->name}}</span></p>
                                <p>{{$invoice->address}}</p>
                        ...
                        <div class="m-2">
                            <p >Subtotal : {{$invoice->total_price-Auth::user()->delivery_fees}} EGP</p>
                            <p >Service Charges : {{Auth::user()->delivery_fees}} EGP</p>
